...
const Hero = () => {
  ...
  return (
    <section className='w-full bg-[#1a1b1d] h-screen lg:h-[120vh] text-blue-700  pt-20 relative'>
      <div className='contain flex flex-col items-start justify-center h-full relative z-10'>
        <div className='flex flex-col items-start justify-start gap-5 w-full'>
          <h2 className='text-2xl sm:text-4xl lg:text-5xl font-semibold leading-[120%] text-primary'>
